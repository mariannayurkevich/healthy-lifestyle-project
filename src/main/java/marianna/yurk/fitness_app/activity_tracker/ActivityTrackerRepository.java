...
public class ActivityTrackerRepository {
    ...
    public void create(ActivityTracker activityTracker) {
        var updated = jdbcClient.sql("INSERT INTO Activity_tracker(id,activity_type,duration,calories_burned,activity_timestamp) values(?,?,?,?,?)")
                .params(List.of(activityTracker.id(),activityTracker.activityType(),activityTracker.duration(),activityTracker.caloriesBurned(),activityTracker.activityTimestamp()))
                .update();
